...
const Login = () => {
    ...
    return (
        <div className="hero bg-base-200 min-h-screen md:mt-10">
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                ...
                <div className="card-body">
                    ...
                    <div className='mt-3'><div className="font-medium text-xs">Don't Have An Account ? <Link to={'/register'} className='link link-hover text-red-500'>Register</Link></div></div>
                    <div className="divider">OR</div>
                    {/* Google */}
                    <button onClick={hangleGoogleSignin} className="btn bg-white text-black border-[#e5e5e5]">
