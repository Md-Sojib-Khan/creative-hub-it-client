        ...
        <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
            <div className="container mx-auto px-4 md:px-8 lg:px-16">
                ...
                <div className="text-center mb-12 md:mb-16 animate-fadeInUp">
                    <h5 className="text-lg md:text-xl font-semibold text-[#1651A9] mb-2">
                        LATEST SERVICE
                    </h5>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-gray-900 mb-4 md:mb-6 md:w-2xl mx-auto">
                        Explore Our Best Premium Quality Service
                    </h2>
                    <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                        Cutting-edge solutions designed to propel your business into the future with innovation and excellence.
                    </p>
                </div>
